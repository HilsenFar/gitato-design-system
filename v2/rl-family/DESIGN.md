...
Mellemvægtene (550-749) er skaleret på versaler, fordi de sætter labels. To ting holder sig ikke med reservefonte alene og løses i layoutet: en label, der ligger lige på grænsen til én linje, stables på telefon (≤ 400 px: `flex-direction: column`, skilletegnet skjult), og en overskrift, der brydes forskelligt i et smalt bånd, får Archivos højde som `min-height` i netop det bånd (tracker 314-327 px, roll 314-323 px, målt på den nuværende tekst; mål igen, hvis overskriften ændres).
